...
const TRANSITIONS = Object.freeze({
  QUEUED: new Set(['DELIVERED', 'INTERRUPTED', 'FAILED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  DELIVERED: new Set(['ACCEPTED', 'RECOVERING', 'INTERRUPTED', 'FAILED', 'UNVERIFIED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  ACCEPTED: new Set(['WORKING', 'RESULT_CAPTURED', 'RECOVERING', 'INTERRUPTED', 'FAILED', 'UNVERIFIED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  WORKING: new Set(['RESULT_CAPTURED', 'RECOVERING', 'INTERRUPTED', 'FAILED', 'UNVERIFIED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  RESULT_CAPTURED: new Set(['COMPLETED', 'FAILED', 'UNVERIFIED']),
  INTERRUPTED: new Set(['RECOVERING', 'FAILED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  RECOVERING: new Set(['WORKING', 'RESULT_CAPTURED', 'FAILED', 'UNVERIFIED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  REJECTED: new Set([]),
  FAILED: new Set([]),
  UNVERIFIED: new Set(['RECOVERING', 'FAILED', 'CANCEL_REQUESTED', 'CANCELLED_BY_AUTHORITY']),
  CANCEL_REQUESTED: new Set(['RESULT_CAPTURED', 'RECOVERING', 'UNVERIFIED', 'CANCELLED_BY_AUTHORITY']),
...
export function createResultCapture({
  ...
  if (!record || !['ACCEPTED', 'WORKING', 'RECOVERING', 'CANCEL_REQUESTED'].includes(record.state)) {
